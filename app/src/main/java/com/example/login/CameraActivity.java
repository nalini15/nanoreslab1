...
public class CameraActivity extends AppCompatActivity {
    ...
    String ImageUploadPathOnSever ="https://192.168.2.10/Camera/capture_img_upload_to_server.php" ;
    ...
    public void ImageUploadToServerFunction(){
        ...
        class AsyncTaskUploadClass extends AsyncTask<Void,Void,String> {
            ...
            protected void onPreExecute() {
                ...
                progressDialog = ProgressDialog.show(CameraActivity.this,"Image is Uploading","Please Wait",false,false);
            }
